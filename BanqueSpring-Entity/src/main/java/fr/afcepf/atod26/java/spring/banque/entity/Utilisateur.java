...
public class Utilisateur {
	 ...
	 */
	public Utilisateur(final String paramNom, final String paramPrenom, final String paramMail,
	 ...
	 * @param paramMotDePasse
	 */
	public Utilisateur(final Integer paramIdUtilisateur, final String paramNom, final String paramPrenom,
