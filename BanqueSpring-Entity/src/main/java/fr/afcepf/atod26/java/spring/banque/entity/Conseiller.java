...
public class Conseiller extends Utilisateur {
	 ...
	 */
	public Conseiller(final Integer paramIdUtilisateur, final String paramNom, final String paramPrenom,
	 ...
	 * @param paramMotDePasse
	 */
	public Conseiller(final String paramNom, final String paramPrenom, final String paramMail,
